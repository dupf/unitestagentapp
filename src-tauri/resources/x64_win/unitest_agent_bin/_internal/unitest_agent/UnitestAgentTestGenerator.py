...
from unitest_agent.Runner import Runner
from unitest_agent.CustomLogger import CustomLogger
from unitest_agent.utils import load_yaml
class UnitestAgentTestGenerator:
    def __init__(self, 
    ...
    def get_code_language(self, source_file_path):
        # TODO: Implement this method to determine the code language
        ...
        if extension_s in extension_to_language:
    ...
    def run_coverage(self):
        # TODO: Implement this method to run coverage
        # This is a placeholder and should be replaced with actual implementation
        self.logger.info(
        ...
        # self.last_coverage_percentages = coverage_processor.get_coverage_percentages()

        try:
            if self.use_report_coverage_feature_flag:
                self.logger.info(f"Getting coverage percentages from report")
    ...
    #TODO: run coverage using llm
    def run_coverage_llm(self):
        # TODO: Implement this method to run coverage
        # This is a placeholder and should be replaced with actual implementation
        self.logger.info(
            f'Running build/test command to generate coverage report: "{self.test_command}"'
    ...
    def build_prompt(self):
        # TODO: Implement this method to build the prompt
        # This is a placeholder and should be replaced with actual implementation
        # pass
        ...
        # print("code_coverage_report======", self.code_coverage_report)
        # if not self.code_coverage_report:
    ...
    def initial_test_suite_analysis(self):
        ...
        try:
            ...
            print("self.test_headers_indentation======", self.test_headers_indentation)
    ...
    def generate_tests_htzr_cn(self, max_tokens=4096, dry_run=False):
        ...
        try:
            tests_dict = load_yaml(
                response,
                keys_fix_yaml=["测试用例编号", "测试技术", "测试用例描述", "测试代码", "全局变量", "初始化代码", "桩函数", "输入", "预期输出", "实际输出", "结论"],
            )
            if tests_dict is None:
                return {}
        except Exception as e:
    ...
    def validate_test(self, generated_test: dict, generated_tests_dict: dict, num_attempts=1):
        ...
        Returns:
            dict: A dictionary containing the status of the test validation, including pass/fail status, 
    ...
    def validate_test_immediately(self, generated_test: dict, generated_tests_dict: dict, num_attempts=1):
        """
        Validate a generated test by inserting it into the test file, running the test, and checking for pass/fail.
        Parameters:
            generated_test (dict): The generated test to validate, containing test code and additional imports.
        ...
        try:
            ...
            if test_code_indented and relevant_line_number_to_insert_tests_after:
                ...
                for i in range(num_attempts):
                    ...
                    #     command=self.test_command, cwd=self.test_command_dir
                    # )
                    stdout, stderr, exit_code, time_of_test_command = '','',0,0
                    if exit_code != 0:
                        break
                # # Step 3: Check for pass/fail from the Runner object
                # if exit_code != 0:
