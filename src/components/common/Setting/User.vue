...
<template>
  <div class="p-4 space-y-5 min-h-[200px] max-h-80 overflow-auto">
    <NForm ref="formRef" :model="model" :rules="rules">
      ...
      <NFormItem path="source_file_path" :label="$t('setting.source_file_path')">
        <!-- <NInput v-model:value="model.source_file_path" :placeholder="$t('setting.avatarLinkPlaceholder')" /> -->
      </NFormItem>
